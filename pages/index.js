...
export default function Home() {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      <h1 className='font-sans text-5xl justify-center font-bold pt-5 '>Rasesh's Code Translator</h1>
      ...
      <a className=' flex font-sans mb-5 p-1 items-center' href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('Check out this awesome code translator!')}&url=${encodeURIComponent('https://dcodeblock.com')}`} target="_blank" rel="noopener noreferrer"><Image className='mr-0.5 justify-center' src={twitter_image} alt="Twitter" />Share it on Twitter</a>
    </div>
